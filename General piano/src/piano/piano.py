...
import claude_piano_visualizer as vis # let me have this man :( i am not a cheater
...
keys_mapped = k_m.keyboard_mapping(octaves_notes)
print("keys mapped")
...
key_rects = vis.init_visualizer(keys_mapped) 
active_keys = set() 
...
while run:
    ...
    vis.draw_visualizer(screen, key_rects, active_keys, font) 
    pygame.display.flip()
